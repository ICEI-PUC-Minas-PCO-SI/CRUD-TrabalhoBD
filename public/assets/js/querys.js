...
const createOrder = `INSERT INTO pedidos (id_pedido, data, valor_total, id_usuario, id_combinacao) VALUES ($1, $2, $3, $4, $5) RETURNING *`;
...
const updateOrder = `UPDATE pedidos SET
                     SET
                        data = $1,
                        valor_total = $2
                        WHERE id_pedido = $3
...
const deleteOrderById = async(orderId) => {
    ...
    try {
        ...
        console.error(`Erro ao deletar pedido ${orderId}`);
    }
};
